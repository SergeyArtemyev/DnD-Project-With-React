...
const RacialTraits = () => {
  ...
  if (race === "Halfling") {
    racialTraits = (
      <>
        ...
        <p className="underline">Brave</p>
        <p>You have advantage on saving throws against being frightened.</p>
        <p className="underline">Halfling Nimbleness</p>
  ...
  if (race === "Dwarf") {
    racialTraits = (
      <>
        ...
        <p className="underline">Dwarven Combat Training</p>
        <p>You have proficiency with the battleaxe, handaxe, light hammer, and warhammer.</p>
        <p className="underline">Stonecunning</p>
        <p>
  ...
  return <div className="racial-traits white">{racialTraits}</div>;
};
